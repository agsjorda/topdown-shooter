...
namespace InventorySystem
{
    ...
    public class DoubleClickHandler
    {
        ...
        private EquipmentSlotTypeSO lastClickedEquipmentType;
        ...
        public bool RegisterClick(int slotIndex, bool isEquipmentSlot = false, EquipmentSlotTypeSO equipmentType = null)
        {
        ...
        private bool IsSameSlot(int slotIndex, bool isEquipmentSlot, EquipmentSlotTypeSO equipmentType)
        {
